...
# input function:
# instructs TensorFlow how to preprocess the data, as well as how to batch, shuffle, and repeat it during model training.
...
# how well our predictions match our targets, in terms of overall summary statistics.
